        ...
        <div className="credits-wrapper">
            ...
            <div className="credits-opening-remarks">
                ...
                <div className="cor-message">
                    <div className="cor-message-header"> <FadeInView>Thank you for helping out peko~!</FadeInView></div>
                    <div className="cor-message-body">
                        ...
                        <br /><br />
                        <FadeInView>In case you're looking at this Usada Pekora, please enjoy this website.</FadeInView>
                    </div>
                </div>
